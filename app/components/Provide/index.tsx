                ...
                <div className='grid grid-cols-1 gap-8 lg:grid-cols-12'>
                    ...
                    <div className='flex justify-center col-span-6'>
                        <div className="flex flex-col justify-center p-10 align-middle">
                            ...
                            <h4 className="pt-4 text-lg font-normal text-center lh-33 lg:text-start text-bluegray">No more juggling multiple tools and platforms. With Twinmo's Testrunz, you have a single unified platform for every aspect of product development. This includes all stakeholders - engineers, lab managers, technicians, research, development, and production teams. Streamline every type of experiment or test, and manage all units under test, from components to subsystems to the full product.</h4>
